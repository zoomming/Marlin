...
#ifndef DWIN_CREALITY_LCD_CUSTOM_ICONS
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT 1  // Ender 3S1 v301 Configs
 ...
 */
#define BAUDRATE 250000   // Ender 3S1 v301 Configs
#define LCD_BAUDRATE 115200   // Ender 3S1 v301 Configs
#define BAUD_RATE_GCODE     // Enable G-code M575 to set the baud rate   // Ender 3S1 v301 Configs
...
//#define CUSTOM_MACHINE_NAME "Ender 3S1 UBL-BLTouch 10x10"   // Ender3S1 Config
 ...
 */
#if HAS_SPRITE_PRO
  #if defined(TYPE_SPRITE_SENSOR)
    #define TEMP_SENSOR_0 TYPE_SPRITE_SENSOR  // SPRITE PRO Configs
  #else
    #define TEMP_SENSOR_0 13  // SPRITE PRO Configs
  #endif
#elif defined(CUSTOM_TEMP_SENSOR)
  #define TEMP_SENSOR_0 CUSTOM_TEMP_SENSOR
#else
...
#define TEMP_SENSOR_BED 1   // Ender 3S1 v301 Configs
...
#define HEATER_0_MINTEMP   0   // Ender 3S1 v301 Configs
...
#define BED_MINTEMP        0   // Ender 3S1 v301 Configs
...
#if HAS_SPRITE_PRO
  #define HEATER_0_MAXTEMP 315  // SPRITE PRO Configs
#elif defined(CUSTOM_TEMP_MAX)
  #define HEATER_0_MAXTEMP CUSTOM_TEMP_MAX
#else
  #define HEATER_0_MAXTEMP 275  // Ender3v2 Configs
#endif
...
#define BED_MAXTEMP      110 // Ender 3S1 v301 Configs
...
// Enable PIDTEMP for PID control.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    // Ender 3S1 v301 Configs
    #define DEFAULT_Kp  17.10   // Ender 3S1 v301 Configs
    #define DEFAULT_Ki   1.40   // Ender 3S1 v301 Configs
    #define DEFAULT_Kd  52.80   // Ender 3S1 v301 Configs
  #endif
#endif // PIDTEMP
 ...
 */
    ...
    #if HAS_MPC_EDIT_MENU
      #define MPC_EDIT_MENU                             // Add MPC editing to the "Advanced Settings" menu. (~1300 bytes of flash)
      #undef HAS_MPC_EDIT_MENU
    #endif
 ...
 * @section bed temp
 */
#define PIDTEMPBED  // Ender 3S1 v301 Configs
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp  54.85  // Stock Ender3S1 PID
  #define DEFAULT_bedKi  10.05  // Stock Ender3S1 PID
  #define DEFAULT_bedKd 199.40  // Stock Ender3S1 PID
...
#define EXTRUDE_MINTEMP 180   // Ender 3S1 v301 Configs
...
#define EXTRUDE_MAXLENGTH 1000   // Ender 3S1 v301 Configs
...
//#define POLARGRAPH
  ...
  #define PEN_UP_DOWN_MENU                // Add "Pen Up" and "Pen Down" to the MarlinUI men
#endif
...
//#define ENDSTOPPULLUPS       // Ender 3S1 v301 Configs
#if DISABLED(ENDSTOPPULLUPS)
  // Disable ENDSTOPPULLUPS to set pullups individually
  //#define ENDSTOPPULLUP_XMIN
  //#define ENDSTOPPULLUP_YMIN
  #define ENDSTOPPULLUP_ZMIN    // Ender 3S1 v301 Configs
  ...
  #define ENDSTOPPULLUP_ZMIN_PROBE // Ender 3S1 v301 Configs
#endif
 ...
 * :['A4988', 'A5984', 'DRV8825', 'LV8729', 'L6470', 'L6474', 'POWERSTEP01', 'TB6560', 'TB6600', 'TMC2100', 'TMC2130', 'TMC2130_STANDALONE', 'TMC2160', 'TMC2160_STANDALONE', 'TMC2208', 'TMC2208_STANDALONE', 'TMC2209', 'TMC2209_STANDALONE', 'TMC26X', 'TMC26X_STANDALONE', 'TMC2660', 'TMC2660_STANDALONE', 'TMC5130', 'TMC5130_STANDALONE', 'TMC5160', 'TMC5160_STANDALONE']
 */
#define X_DRIVER_TYPE TMC2208_STANDALONE   // Ender 3S1 v301 Configs
#define Y_DRIVER_TYPE TMC2208_STANDALONE   // Ender 3S1 v301 Configs
#define Z_DRIVER_TYPE TMC2208_STANDALONE   // Ender 3S1 v301 Configs
//#define X2_DRIVER_TYPE A4988
//#define Y2_DRIVER_TYPE A4988
//#define Z2_DRIVER_TYPE A4988
//#define Z3_DRIVER_TYPE A4988
...
//#define J_DRIVER_TYPE  A4988
//#define K_DRIVER_TYPE  A4988
#define E0_DRIVER_TYPE TMC2208_STANDALONE   // Ender 3S1 v301 Configs
//#define E1_DRIVER_TYPE A4988
//#define E2_DRIVER_TYPE A4988
//#define E3_DRIVER_TYPE A4988
//#define E4_DRIVER_TYPE A4988
...
#define ENDSTOP_INTERRUPTS_FEATURE   // Ender 3S1 v301 Configs
 ...
 */
#ifdef CUSTOM_E_STEPS
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, CUSTOM_E_STEPS }   // CUSTOM E_STEPS
#else
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 425 }   // Ender 3S1 v301 Configs
#endif
...
#elif defined(CUSTOM_E_STEPS)  
  #define DEFAULT_MAX_FEEDRATE          { 500, 500, 20, 25 }
#else
  #define DEFAULT_MAX_FEEDRATE          { 500, 500, 20, 80 }    // Ender3v2 Configs
#endif   // Ender 3S1 v301 Configs increased by tititopher68-dev
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 200, 5000 }   // Ender 3S1 v301 Configs increased by tititopher68-dev
 ...
 */
#define DEFAULT_ACCELERATION          500    // X, Y, Z and E acceleration for printing moves   // Ender 3S1 v301 Configs
#define DEFAULT_RETRACT_ACCELERATION  800    // E acceleration for retracts   // Ender 3S1 v301 Configs
#define DEFAULT_TRAVEL_ACCELERATION   1000    // X, Y, Z acceleration for travel (non printing) moves   // Ender 3S1 v301 Configs
 ...
 */
...
#else
  #define CLASSIC_JERK
#endif   // Ender 3S1 v301 Configs
#if ENABLED(CLASSIC_JERK)
  #define DEFAULT_XJERK 5.0  // Ender 3S1 v301 Configs
  #define DEFAULT_YJERK 5.0  // Ender 3S1 v301 Configs
  #define DEFAULT_ZJERK  0.3  // Ender 3S1 v301 Configs
  ...
  //#define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 20, 20, 1, 20 } // ...or, set your own edit limits // Ender 3S1 v301 Configs
  #endif
#endif
 ...
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN // Ender 3S1 v301 Configs

// Force the use of the probe for Z-axis homing
#define USE_PROBE_FOR_Z_HOMING // Ender 3S1 v301 Configs
 ...
 */
#define BLTOUCH // Ender 3S1 v301 Configs
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -31.8, -40.5, 0 } // Ender 3S1 v301 Configs
...
#define XY_PROBE_FEEDRATE (170*60)   // Ender 3S1 v301 Configs tititoher68-dev increase travel speed between probes

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (16*60)   // Ender 3S1 v301 Configs tititopher68-dev increase Probe Z SpeedRate
...
#define INVERT_Y_DIR false   // Ender 3S1 v301 Configs
#define INVERT_Z_DIR true    // Ender 3S1 v301 Configs
...
#define Z_HOMING_HEIGHT  4      // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
                                  // Be sure to have this much clearance over your Z_MAX_POS to prevent grinding. // Ender 3S1 v301 Configs

#define Z_AFTER_HOMING  10      // (mm) Height to move to after homing Z // Ender 3S1 v301 Configs
...
#define Z_MIN_POS 0
#define X_MAX_POS 230  // Ender 3S1 v301 Configs
#define Y_MAX_POS 220  // Ender 3S1 v301 Configs
...
#define FILAMENT_RUNOUT_SENSOR   // Ender3v2 Configs
  ...
  //#define FIL_RUNOUT_PULLUP  // Ender 3S1 v301 Configs  // Use internal pullup for filament runout pins.
  #define FIL_RUNOUT_PULLDOWN  // Ender 3S1 v301 Configs  // Use internal pulldown for filament runout pins.
...
//#define AUTO_BED_LEVELING_BILINEAR // Ender 3S1 v301 Configs
 ...
 */
#if DISABLED(PROBE_MANUALLY, PREHEAT_BEFORE_PROBING)
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #if HAS_UBL_TILT_ON_MESH_POINTS
 ...
 */
#define EEPROM_SETTINGS       // Persistent storage with M500 and M501   // Ender 3S1 v301 Configs
//#define DISABLE_M503        // Saves ~2700 bytes of PROGMEM. Disable for release!
#define EEPROM_CHITCHAT     // Give feedback on EEPROM commands. Disable to save PROGMEM.
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
#if ENABLED(EEPROM_SETTINGS)
  #define EEPROM_AUTO_INIT    // Init EEPROM automatically on any errors.   // Ender 3S1 v301 Configs
  #define EEPROM_INIT_NOW   // Init EEPROM on first boot after a new build.   // Ender 3S1 v301 Configs tititopher68-dev enable to force reset on first boot
#endif
 ...
 */
#define NOZZLE_PARK_FEATURE   // Ender 3S1 v301 Configs

#if ENABLED(NOZZLE_PARK_FEATURE)
  // Specify a park position as { X, Y, Z_raise }
  #define NOZZLE_PARK_POINT { (X_BED_SIZE + 8), (Y_MAX_POS - 2), 20 }  // Ender 3S1 v301 Configs
 ...
 */
#define PRINTCOUNTER   // Ender 3S1 v301 Configs
...
//
#define ENCODER_PULSES_PER_STEP 4   // Ender 3S1 v301 Configs

//
// Use this option to override the number of step signals required to
// move between next/prev menu items.
//
#define ENCODER_STEPS_PER_MENU_ITEM 1   // Ender 3S1 v301 Configs
...
//
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 2   // Ender 3S1 v301 Configs
#define LCD_FEEDBACK_FREQUENCY_HZ 5000   // Ender 3S1 v301 Configs
...
#define FAN_SOFT_PWM   // Ender 3S1 v301 Configss
...
// :[0,1,2,3,4,5,6,7]
#define SOFT_PWM_SCALE 0   // Ender 3S1 v301 Configs
