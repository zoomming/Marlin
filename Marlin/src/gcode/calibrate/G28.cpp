...
#include "../../core/debug_out.h"
  ...
  inline void home_z_safely() {
     ...
     */
    TERN(EXTJYERSUI, , constexpr) xy_float_t safe_homing_xy = { Z_SAFE_HOMING_X_POINT, Z_SAFE_HOMING_Y_POINT };
      ...
      // Home Z last if homing towards the bed
        ...
        if (doZ) {
            ...
            stepper.set_separate_multi_axis(false);
              ...
              if ((HMI_datas.bltouch_validate_ui ? !bltouch.validate() : false)) {
            #else
              if (!bltouch.validate()) {
            #endif
