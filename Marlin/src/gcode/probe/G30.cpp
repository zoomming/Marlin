...
void GcodeSuite::G30() {
  ...
  */
  ...
  if (probe.can_reach(pos)) {
    ...
    #if ENABLED(DWIN_CREALITY_LCD_JYERSUI) && !HAS_RC_CPU
        char msg[31], strg_1[6], strg_2[6],strg_3[6];
        sprintf_P(msg, PSTR("X:%s, Y:%s, Z:%s"), 
          dtostrf(pos.asLogical().x, 1, 1, strg_1),
          dtostrf(pos.asLogical().y, 1, 1, strg_2),
