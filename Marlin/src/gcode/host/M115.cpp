  ...
  SERIAL_ECHOPGM("FIRMWARE_NAME:Marlin"
    ...
    // Machine Geometry
      ...
      const xyz_pos_t bmin{0},
                      bmax = ARRAY_N(LINEAR_AXES, X_BED_SIZE, Y_BED_SIZE, Z_MAX_POS, I_MAX_POS, J_MAX_POS, K_MAX_POS),
                      dmin = ARRAY_N(LINEAR_AXES, X_MIN_POS,  Y_MIN_POS,  Z_MIN_POS, I_MIN_POS, J_MIN_POS, K_MIN_POS),
                      dmax = ARRAY_N(LINEAR_AXES, X_MAX_POS,  Y_MAX_POS,  Z_MAX_POS, I_MAX_POS, J_MAX_POS, K_MAX_POS);
