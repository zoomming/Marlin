...
#if ANY(HAS_DGUS_LCD_CLASSIC, DGUS_LCD_UI_RELOADED, ANYCUBIC_LCD_VYPER)
...
// E3V2 extras
  ...
  /**
      ...
      #define LCD_SERIAL_PORT 2 // Creality Ender3S1 board and Ender2 Pro board
    #else
  ...
  */
  #define HAS_LCD_BRIGHTNESS 1
    ...
    #define LCD_BRIGHTNESS_MAX 255
      ...
      #if ENABLED(DACAI_DISPLAY)
        #define LCD_BRIGHTNESS_DEFAULT 32
      #else
...
//#if MAP(_OR_HAS_DA, X, Y, Z, I, J, K) 0
