 ...
 */
    ...
    #endif
  #elif DISABLED(SDSORT_CACHE_NAMES)
    #if ENABLED(SDSORT_DYNAMIC_RAM)
 ...
 */
  ...
  static_assert(COUNT(npp) == _MIN(LINEAR_AXES, XYZ), "NOZZLE_PARK_POINT requires coordinates for enabled axes, but only up to X,Y,Z.");
 ...
 */
   ...
   */
    ...
    #elif DISABLED(BABYSTEP_ZPROBE_OFFSET) && DISABLED(DWIN_CREALITY_LCD_JYERSUI)
...
#if COUNT_SENSORLESS && COUNT_SENSORLESS != NUM_Z_STEPPER_DRIVERS
 ...
 */
#if ENABLED(Z_SAFE_HOMING) && !EXTJYERSUI
 ...
 */
  ...
  #endif
#elif ANY(DWIN_LCD_PROUI, DWIN_CREAITY_LCD_JYERSUI)
  #if DISABLED(SDSUPPORT)
    #error "DWIN_LCD requires SDSUPPORT to be enabled."
  #elif EITHER(PID_EDIT_MENU, PID_AUTOTUNE_MENU)
    #error "DWIN_CREALITY_LCD does not support PID_EDIT_MENU or PID_AUTOTUNE_MENU."
  #elif ENABLED(LEVEL_BED_CORNERS)
    #error "DWIN_LCD does not support LEVEL_BED_CORNERS."
  #elif BOTH(LCD_BED_LEVELING, PROBE_MANUALLY)
    #error "DWIN_LCD does not support LCD_BED_LEVELING with PROBE_MANUALLY."
  #endif
#endif

#if HAS_BACKLIGHT_TIMEOUT
  #if !HAS_ENCODER_ACTION && DISABLED(DWIN_CREALITY_LCD_JYERSUI)
    ...
    #endif
  #elif !PIN_EXISTS(LCD_BACKLIGHT) && DISABLED(DWIN_CREALITY_LCD_JYERSUI)
 ...
 */
    ...
    #error "DGUS_LCD_UI RELOADED requires LEVEL_BED_CORNERS."
 ...
 */
    ...
    #error "DGUS_LCD_UI IA_CREALITY only support up to 1 NUM_RUNOUT_SENSORS."
  #elif NONE(AUTO_BED_LEVELING_BILINEAR, AUTO_BED_LEVELING_UBL, MESH_BED_LEVELING)
 ...
 */
#if ENABLED(AVOID_OBSTACLES) && EXTJYERSUI
  #error "AVOID_OBSTACLES isn't allowed for this firmware."
  #error "AVOID_OBSTACLES n'est pas autorisé avec ce firmware."
#endif
