...
/**
 * Functionality desativated with Extented JyersUI
*/
#if ENABLED(EXTJYERSUI, DWIN_CREALITY_LCD_JYERSUI)

  #if HAS_RC_CPU_AND_UBL
    #warning "Host_Actions Menus and E-Calibration tool will be desactivated"
    #if HAS_RC_CPU_AND_SHAPING
      #warning "HAS_SCREENLOCK will be desativated"
      #if HAS_UBL_TILT_ON_MESH_POINTS
        #warning "HAS_UBL_TILT_ON_MESH_POINTS will be desativated"
      #endif
      #if (E0_AUTO_FAN_PIN != -1)
        #warning "PID_GRAPH will be desativated"
      #else
        #warning "HAS_BLTOUCH_CHECK will be desativated"
      #endif
      #if HAS_NO_AUTOTILT_AFTERNPRINT
        #warning "Autotilt After N Print will be desativated"
      #endif
      #if ENABLED(LIN_ADVANCE, EXPERIMENTAL_SCURVE)
        #warning "EXPERIMENTAL_SCURVE will be desactivated"
      #endif
    #endif
  #endif

  #if HAS_RC_CPU_AND_SHAPING
    #warning "Host_Actions Menus will be desactivated"
  #endif

  #if HAS_RC_CPU_AND_MPC || ENABLED(HAS_RC_CPU, AUTO_BED_LEVELING_BILINEAR, LIN_ADVANCE, HAS_BED_PROBE)
    #warning "E-Calibration tool Menus will be desactivated"
  #endif
