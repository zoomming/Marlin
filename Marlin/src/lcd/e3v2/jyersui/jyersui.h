...
// ICON ID
  ...
  constexpr uint8_t char_xoffset = 1;
  constexpr uint8_t fontsize = 8;
#else
  #define meshfont font6x12
  constexpr uint8_t char_xoffset = 0;
  ...
  #define ICON_Probe                ICON_StockConfiguration
...
#endif
#define ICON_ECalTool_S           220
#define ICON_ECalTool_E           221
...
namespace JYERSUI {
  ...
  extern uint8_t  font;
    ...
    extern uint16_t last_backcolor;
  #endif
