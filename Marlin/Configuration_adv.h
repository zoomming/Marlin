...
//#define DUAL_X_CARRIAGE
  ...
  // This is the default power-up mode which can be later changed later using M605 S<mode>.
...
// @section bltouch
  ...
  #if HAS_BLTOUCH_CHECK
    #define BLTOUCH_VALIDATE_ON_HOMING
    #undef HAS_BLTOUCH_CHECK
  #else
    //#define BLTOUCH_VALIDATE_ON_HOMING
  #endif
 ...
 */
  ...
  //#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  108.87 //DBI 40          // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X  0.15f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
#endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  105.77 //DBI 40          // (Hz) The default dominant resonant frequency on the Y axis.
...
#define LCD_BACKLIGHT_TIMEOUT 120 //DBI 0 // (s) Timeout before turning off the backlight
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  //#define SD_ABORT_ON_ENDSTOP_HIT
    ...
    //#define SD_ABORT_ON_ENDSTOP_HIT_GCODE "G27 P2" // G-code to run on endstop hit (e.g., "G28XY" or "G27")
  #endif
 ...
 */
  ...
  #if HAS_EXPERIMENTAL_SCURVE
    #define EXPERIMENTAL_SCURVE // Enable this option to permit S-Curve Acceleration
  #else
    //#define EXPERIMENTAL_SCURVE
  #endif // Enable this option to permit S-Curve Acceleration
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g., 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE 16 // default 16
#else
...
#define TX_BUFFER_SIZE 64 // default 32
...
#define FWRETRACT
  ...
  #endif
  #define RETRACT_LENGTH                3.0 //DBI 6   // (mm) Default retract length (positive value)
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #if HAS_SPRITE_PRO
    #define FILAMENT_CHANGE_UNLOAD_LENGTH      20 //DBI 100  // (mm) The length of filament for a complete unload.
  #else
  ...
  #if HAS_SPRITE_PRO
    #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   10 //DBI 100  // (mm) Load length of filament, from extruder gear to nozzle.
  #else
  ...
  #define ADVANCED_PAUSE_PURGE_LENGTH         10 //DBI 50  // (mm) Length to extrude after loading.
