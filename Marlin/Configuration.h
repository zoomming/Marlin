...
//#define CUSTOM_MACHINE_NAME "Ender-3 V2 UBL-BLTouch 10x10"   // Ender3v2 Configs

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
//#define MACHINE_UUID "00000000-0000-0000-0000-000000000002" //DBI
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    // Ender 3 v2
    #define DEFAULT_Kp  16.90 //DBI //18.69 //28.72   // Ender3v2 Configs
    #define DEFAULT_Ki   1.39 //DBI //1.74 //2.62   // Ender3v2 Configs
    #define DEFAULT_Kd  51.38 //DBI //50.10 //78.81   // Ender3v2 Configs
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Ender 3 V2
  #define DEFAULT_bedKp 113.64 //DBI 462.10
  #define DEFAULT_bedKi  18.94 //DBI 85.47
  #define DEFAULT_bedKd 454.56 //DBI 624.59
 ...
 */
#if HAS_SPRITE_PRO
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 424.9 }  // SPRITE PRO
...
#endif   // Ender3v2 Configs increased by tititopher68-dev
 ...
 */
#if HAS_SPRITE_PRO
  #define NOZZLE_TO_PROBE_OFFSET { -31.8, -40.5, -3.30 } //DBI
#else
...
#define PROBING_MARGIN 5 // DBI 10
...
#ifndef X_BED_SIZE
  #define X_BED_SIZE 230 //DBI 230   // Ender3v2 Configs
#endif
#ifndef Y_BED_SIZE
  #define Y_BED_SIZE 230 //DBI 230
#endif

// Travel limits (mm) after homing, corresponding to endstop positions.
#ifdef HOME_X_OFFSET
  #define X_MIN_POS HOME_X_OFFSET
#else
  #define X_MIN_POS 0
#endif
#ifdef HOME_Y_OFFSET
  #define Y_MIN_POS HOME_Y_OFFSET
#else
  #define Y_MIN_POS 0
#endif
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE + 25 //DBI 15 // Extended max to allow the probe to reach more of the bed.   // Ender3v2 Configs
#define Y_MAX_POS Y_BED_SIZE +30 //DBI 0  // Ender3v2 Configs
#define Z_MAX_POS 240 //DBI 250   // Ender3v2 Configs
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
#define FILAMENT_RUNOUT_SENSOR   // Ender3v2 Configs
  ...
  #define FIL_RUNOUT_DISTANCE_MM { 7 } //DBI 15 }
...
//
  ...
  #define PREHEAT_1_TEMP_HOTEND  180 //DBI 210
  #define PREHEAT_1_TEMP_BED      50 //DBI 70
  #define PREHEAT_1_FAN_SPEED      0 // Value from 0 to 255

  #define PREHEAT_2_LABEL       "PLA"
  #define PREHEAT_2_TEMP_HOTEND  210
  #define PREHEAT_2_TEMP_BED      65 //DBI 60
  #define PREHEAT_2_FAN_SPEED      0 // Value from 0 to 255

  #define PREHEAT_3_LABEL       "ABS"
  #define PREHEAT_3_TEMP_HOTEND  240
  #define PREHEAT_3_TEMP_BED     100 //DBI 90
